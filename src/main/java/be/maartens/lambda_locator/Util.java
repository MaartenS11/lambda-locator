package be.maartens.lambda_locator;
...
public class Util {
    ...
    public static void printClass(ClassPool classPool, String className) {
        new ClassPrinter(new Printer(new OutputStreamWriter(System.out))).visitProgramClass((ProgramClass) classPool.getClass(className));
    }
}
